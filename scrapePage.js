...
const outputFileA = "output2/sample_01.json"
// const outputFileB = "output2/sample_02.json"
// const outputFileC = "output2/sample_03.json"
// const outputFileD = "output2/sample_04.json"
...
//   await submitButton.click()
  ...
  await page.waitForSelector('#attContainer', {timeout: 2000})
  .then( () => {
    const attContainerDiv = page.$('#attContainer')
    if (attContainerDiv) {
      // Get all elements with p tag
      const pElements = page.$$('#attContainer p')
      let extractedTexts = []
      for (let i = 0; i < pElements.length; i++) {
        // Get the text from the element
        const textContent = page.evaluate(element => element.innerText.replace(/\\/g, ''), pElements[i])
...
void main('A-00755599', "cacheFolder", outputFileA)
